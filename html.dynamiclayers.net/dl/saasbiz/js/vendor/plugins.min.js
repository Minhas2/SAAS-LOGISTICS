...
! function(e) {
    e.fn.niceSelect = function(t) {
        ...
        this.hide(), this.each(function() {
            ...
            var s = e(this);
            e(".nice-select").not(s).removeClass("nc-open"), s.toggleClass("nc-open"), s.hasClass("nc-open") ? (s.find(".option"), s.find(".focus").removeClass("focus"), s.find(".selected").addClass("focus")) : s.focus()
        }), e(document).on("click.nice_select", function(t) {
            0 === e(t.target).closest(".nice-select").length && e(".nice-select").removeClass("nc-open").find(".option")
            ...
            if (32 == t.keyCode || 13 == t.keyCode) return s.hasClass("nc-open") ? n.trigger("click") : s.trigger("click"), !1;
            if (40 == t.keyCode) {
                if (s.hasClass("nc-open")) {
            ...
            if (27 == t.keyCode) s.hasClass("nc-open") && s.trigger("click");
            else if (9 == t.keyCode && s.hasClass("nc-open")) return !1
        });
